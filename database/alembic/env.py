...
# Add parent directory of 'database' to python path to load models
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "../..")))

from models import Base
from database.connection import SYNC_DATABASE_URL, ASYNC_DATABASE_URL
...
def run_migrations_offline() -> None:
    ...
    """
    # Use sync connection URL for offline migrations
    context.configure(
